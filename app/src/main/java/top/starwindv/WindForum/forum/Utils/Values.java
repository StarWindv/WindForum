...
public class Values implements Iterable<Object> {
    ...
    public static Values onlyResult(Object... elements) {
        return new Values("", "", elements, "");
    }
    public static Values onlyResult(String defaultValues, Object... elements) {
        return new Values(defaultValues, defaultValues, elements, defaultValues);
    }
